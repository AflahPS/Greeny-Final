                    ...
                    (t.controllers.bar = t.DatasetController.extend({
                      ...
                      calculateBarIndexPixels: function (t, e, i) {
                        var n = i.scale.options,
                          ...
                          s = a.start + a.chunk * r + a.chunk / 2,
                          l = Math.min(
                            o.valueOrDefault(n.maxBarThickness, 1 / 0),
                            a.chunk * a.ratio
                          );
                        return {
                          base: s - l / 2,
                    ...
                    callbacks: {
                      ...
                      label: function (t, e) {
                        var i = e.labels[t.index],
                          n = ': ' + e.datasets[t.datasetIndex].data[t.index];
                        return (
                          o.isArray(i) ? ((i = i.slice())[0] += n) : (i += n), i
                        );
                      },
                    },
                  },
                    ...
                    t.controllers.line = t.DatasetController.extend({
                      ...
                      updateBezierControlPoints: function () {
                        ...
                        if (
                          ...
                          'monotone' ===
                            a.dataset._model.cubicInterpolationMode)
                        )
                    ...
                    a.extend(t.prototype, {
                      ...
                      updateHoverStyle: function (t, e, i) {
                        ...
                        for (a = 0, o = t.length; a < o; ++a)
                          (n = t[a]) &&
                            this.getDatasetMeta(n._datasetIndex).controller[r](
                              n
                            );
                      },
                      ...
                      handleEvent: function (t) {
                        ...
                        return (
                          ...
                          ('mouseup' !== t.type && 'click' !== t.type) ||
                            (n.onClick &&
                              n.onClick.call(i, t.native, i.active)),
                          i.lastActive.length &&
                    ...
                    if (t) {
                      ...
                      n.each(h.concat(f, g, p), function (t) {
                        var e,
                          i = t.isHorizontal();
                        i
                          ? ((e = t.update(t.fullWidth ? v : w, k)),
                            (M -= e.height))
                          : ((e = t.update(y, M)), (w -= e.width)),
                      ...
                      var O = Math.max(C - I, 0);
                      (I += O), (A += Math.max(_ - A, 0));
                      var R = Math.max(D - T, 0);
                      (T += R), (F += Math.max(P - F, 0));
                      var L = i - T - F,
                        z = e - I - A;
                      (z === w && L === M) ||
                        (n.each(h, function (t) {
                        ...
                        if (a.length && t.options.display && t.isHorizontal())
                          for (
                            var u,
                              ...
                              c = d,
                              h =
                                t.getPixelForTick(1) - t.getPixelForTick(0) - 6;
                            c > h && l < n.maxRotation;
                          ...
                          var s = e.ctx,
                            ...
                            P =
                              'right' === a.position
                                ? e.right
                                : e.right - D - k,
                            I = 'right' === a.position ? e.right + k : e.right,
                            A =
                              'bottom' === a.position
                                ? e.top + D
                                : e.bottom - k - D,
                    ...
                    (t.Tooltip = a.extend({
                      ...
                      update: function (e) {
                        ...
                        if (p.length) {
                          ...
                          var k = [],
                            w = [];
                          y = t.Tooltip.positioners[h.position].call(
                            c,
                            p,
                            c._eventPosition
                          );
                          ...
                          h.filter &&
                            ...
                            o.each(M, function (t) {
                              k.push(
                                h.callbacks.labelColor.call(c, t, c._chart)
                              ),
                                w.push(
                            ...
                            (g.title = c.getTitle(M, m)),
                            (g.beforeBody = c.getBeforeBody(M, m)),
                            (g.body = c.getBody(M, m)),
                            (g.afterBody = c.getAfterBody(M, m)),
                            (g.footer = c.getFooter(M, m)),
                            (g.x = Math.round(y.x)),
                            (g.y = Math.round(y.y)),
                ...
                var n,
                  a = {
                    ...
                    merge: function (t, e, i) {
                      ...
                      for (
                        n = (i = i || {}).merger || a._merger, o = 0;
                        o < d;
                        ++o
                      )
                        if (((e = u[o]), a.isObject(e)))
                          for (
                            l = 0, s = (r = Object.keys(e)).length;
                            l < s;
                            ++l
                          )
                            n(r[l], t, e, i);
                ...
                function p(t, e, i) {
                  var u,
                    ...
                    m = (p.resizer = (function (t) {
                      ...
                      ((u = function () {
                        if (p.resizer) return e(g('resize', i));
                      }),
                      (c = !1),
                      (f = []),
                      function () {
              ...
              function (t, e, i) {
                ...
                function l(t) {
                  ...
                  if (
                    ('start' === a
                      ? (o =
                          void 0 === i.scaleBottom ? n.bottom : i.scaleBottom)
                      : 'end' === a
                      ...
                      u &&
                        ...
                        (function (t, e, i, n, a, o) {
                          ...
                          for (t.beginPath(), r = 0, s = p + !!o; r < s; ++r)
                            (d = i((u = e[(l = r % p)]._view), l, n)),
                              (f = c(u)),
                              (g = c(d)),
                              f && g
                                ? ((x = v.push(u)), (y = b.push(d)))
                                : x &&
                                  y &&
                                  (m
                                    ? (f && v.push(u), g && b.push(d))
                                    : (h(t, v, b, x, y),
                                      (x = y = 0),
                                      (v = []),
                                      (b = [])));
                      ...
                      if (((r.font = f), m)) {
                        ...
                        (r.textAlign = 'left'),
                          ...
                          o.each(t.legendItems, function (e, n) {
                            var a =
                              l(i, d) + d / 2 + r.measureText(e.text).width;
                        ...
                        o.each(t.legendItems, function (t, e) {
                          ...
                          M + S > p.height &&
                            ((k += w + i.padding), y.push(w), (w = 0), (M = 0)),
                            (w = Math.max(w, n)),
                            (M += S),
                    ...
                    draw: function () {
                      ...
                      if (i.display) {
                        var h = t.ctx,
                          ...
                          m = l(o.fontFamily, e.defaultFontFamily),
                          v = a.fontString(g, p, m);
                        a.each(t.ticks, function (i, s) {
                          if (s > 0 || o.reverse) {
                            ...
                            if (
                              ...
                              var d = l(o.fontColor, e.defaultFontColor);
                              if (
                                ((h.font = v),
                                h.save(),
                                ...
                                (h.fillStyle = o.backdropColor),
                                  h.fillRect(
                                    -c / 2 - o.backdropPaddingX,
                                    -u - g / 2 - o.backdropPaddingY,
                                    c + 2 * o.backdropPaddingX,
                                    g + 2 * o.backdropPaddingY
                                  );
                              }
                              (h.textAlign = 'center'),
                          ...
                          (i.angleLines.display || i.pointLabels.display) &&
                            (function (t) {
                              ...
                              var h = t.getDistanceFromCenterForValue(
                                ...
                                f = s(t);
                              i.textBaseline = 'top';
                              for (var g = r(t) - 1; g >= 0; g--) {
                                if (o.display) {
                                  var p = t.getPointPosition(g, h);
                                  i.beginPath(),
                                ...
                                if (l.display) {
                                  var m = t.getPointPosition(g, h + 5),
                                  ...
                                  var b = t.getIndexAngle(g),
                                    x = a.toDegrees(b);
                                  (i.textAlign = u(x)),
                                    c(x, t._pointLabelSizes[g], m),
                                    d(i, t.pointLabels[g] || '', m, f.size);
                                }
                              }
                            })(t);
                      }
                  ...
                  var e = t.Scale.extend({
                    ...
                    buildTicks: function () {
                      ...
                      switch (s.ticks.source) {
                        ...
                        case 'auto':
                        default:
                          c = m(o, r, a.getLabelCapacity(o), s);
                      }
                      for (
                        'ticks' === s.bounds &&
                          c.length &&
                          ((o = c[0]), (r = c[c.length - 1])),
                          o = g(d.min, a) || o,
                          r = g(d.max, a) || r,
                          t = 0,
                          e = c.length;
                      ...
                      return (
                        ...
                        (a._unit =
                          ...
                          })(v, d.minUnit, a.min, a.max)),
                        (a._majorUnit = p(a._unit)),
                        (a._table = (function (t, e, i, n) {
                          ...
                          return u;
                        })(a._timestamps.data, o, r, s.distribution)),
                    ...
                    getLabelWidth: function (t) {
                      ...
                      return (
                        i * r +
                        o.valueOrDefault(e.fontSize, a.global.defaultFontSize) *
                          s
                      );
                    },
