  ...
  if ($(window).width() > 300) {
    $('#sidebar-option-select').change(function () {
      ...
      if (valueSelected === 'ec-sidebar-fixed') {
        body
          .removeClass(
            'ec-sidebar-fixed-offcanvas ec-sidebar-static ec-sidebar-static-offcanvas sidebar-collapse sidebar-collapse-out sidebar-minified sidebar-minified-out'
          )
          .addClass('ec-sidebar-fixed');
      ...
      if (valueSelected === 'ec-sidebar-fixed-minified') {
        body
          ...
          .addClass('ec-sidebar-fixed sidebar-minified');
      ...
      if (valueSelected === 'ec-sidebar-fixed-offcanvas') {
        body
          .removeClass(
            'ec-sidebar-static ec-sidebar-static-offcanvas sidebar-collapse-out sidebar-minified sidebar-minified-out ec-sidebar-fixed'
          )
          .addClass('ec-sidebar-fixed-offcanvas sidebar-collapse');
      ...
      if (valueSelected === 'ec-sidebar-static') {
        body
          .removeClass(
            'ec-sidebar-fixed-offcanvas ec-sidebar-static-offcanvas sidebar-collapse sidebar-collapse-out sidebar-minified-out ec-sidebar-fixed'
          )
          .addClass('ec-sidebar-static');
        window.isMinified = false;
        window.isCollapsed = false;
      ...
      if (valueSelected === 'ec-sidebar-static-minified') {
        body
          ...
          .addClass('ec-sidebar-static sidebar-minified');
      ...
      if (valueSelected === 'ec-sidebar-static-offcanvas') {
        body
          .removeClass(
            'ec-sidebar-fixed-offcanvas ec-sidebar-static sidebar-collapse-out sidebar-minified sidebar-minified-out ec-sidebar-fixed'
          )
          .addClass('ec-sidebar-static-offcanvas sidebar-collapse');
        window.isCollapsed = true;
        window.isMinified = false;
